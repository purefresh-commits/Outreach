      ...
      <div style={{ padding:"16px 20px" }}>
        ...
        {activeTab === "instructions" && (
          <div style={{ maxWidth:"580px", margin:"0 auto", background:"#fff", borderRadius:"12px", padding:"24px", boxShadow:"0 1px 4px rgba(0,0,0,0.06)" }}>
            ...
            {[
              ["1","Add your contacts","Use the + Add Contact button. Everything saves to the cloud automatically."],
              ["2","Use the Email button","Click 📧 Email on any contact to open Gmail with the message pre-filled. Status updates to Sent automatically."],
              ["3","Use WhatsApp & SMS","Click 💬 WA or 📱 SMS to open pre-filled messages on your phone."],
              ["4","Export to CSV","Click Export CSV to download your contact list for bulk email campaigns."],
              ["5","Import contacts","Click Import CSV to bulk upload contacts from a spreadsheet."],
              ["6","Track replies","Update each contact status as replies come in."],
            ].map(([s,t,d]) => (
